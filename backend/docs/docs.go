...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "email": "support@studentplatform.ru"
        },
        "license": {
            "name": "Apache 2.0",
    ...
    "paths": {
        ...
        "/teacher/activities/{id}/attendance": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/teacher.AttendanceRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/teacher.DashboardResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/teacher.ImportGradesRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/teacher.GroupSummary"
                            }
                        }
                    }
                }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/teacher.GradeWithStudent"
                            }
                        }
                    }
                }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/teacher.StudentProfile"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "dashboard.DashboardResponse": {
            ...
            "properties": {
                "active_challenges": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dashboard.ActiveChallenge"
                    }
                },
                "questionnaire_status": {
                    "$ref": "#/definitions/dashboard.QuestionnaireStatus"
                },
                "recent_grades": {
                    "type": "array",
                    "items": {
                ...
                "student_info": {
                    "$ref": "#/definitions/dashboard.StudentInfo"
                },
                "upcoming_events": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dashboard.UpcomingEvent"
                    }
                }
            }
        },
        "dashboard.QuestionnaireStatus": {
            "type": "object",
            "properties": {
                "comment": {
                    "type": "string"
        ...
        "dashboard.RecentGrade": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "exam, test, homework, etc",
                    "type": "string"
                },
                "value": {
                    "type": "number"
        ...
        "dashboard.UpcomingEvent": {
            ...
            "properties": {
                ...
                "type": {
                    "description": "class, meeting, deadline, etc",
                    "type": "string"
                }
            }
        },
        ...
        "teacher.DashboardResponse": {
            ...
            "properties": {
                ...
                "recent_activities": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/teacher.ActivitySummary"
                    }
                },
                "total_students": {
                    "type": "integer"
        ...
        "teacher.ImportGradesRequest": {
            ...
            "properties": {
                ...
                "grades": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/teacher.GradeImportItem"
                    }
                },
                "group_id": {
                    "type": "string"
